  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Legal &amp; AI disclosures</Text>
          <View style={styles.card}>
            <TouchableOpacity
              onPress={() => Linking.openURL('https://peakher.ai/privacy')}
              style={styles.actionRow}
            >
            ...
            <TouchableOpacity
              onPress={() => Linking.openURL('https://peakher.ai/terms')}
              style={styles.actionRow}
            >
            ...
            <View style={styles.disclaimerCard}>
              ...
              <Text style={styles.disclaimerBody}>
                PeakHer provides wellness and performance insights generated by AI (Anthropic Claude) from data you choose to share. PeakHer is not a medical device and is not a substitute for diagnosis or treatment by a qualified healthcare provider. Your health-adjacent data is treated as sensitive personal information and is not used to train AI models.
              </Text>
            </View>
          </View>
        </View>
