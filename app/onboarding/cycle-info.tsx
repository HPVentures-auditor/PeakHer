  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {/* Sensitive data + not medical advice note */}
        <View style={styles.sensitiveNote}>
          <Text style={styles.sensitiveNoteTitle}>Before you share — the quick version:</Text>
          <Text style={styles.sensitiveNoteBody}>
            Cycle, hormonal, and health-adjacent data you log is treated as{' '}
            <Text style={styles.sensitiveNoteBold}>sensitive personal information</Text>. We encrypt it, we don't sell it, and we don't use it to train AI models. Dot's insights are generated by Anthropic Claude and are{' '}
            <Text style={styles.sensitiveNoteBold}>not medical advice</Text>. You can skip tracking, edit anything later, or delete all your data from Settings at any time.
          </Text>
        </View>
